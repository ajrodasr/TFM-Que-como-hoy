...
public class RecetaFiltradaDTO {
	...
	public RecetaFiltradaDTO() {}
	
	public RecetaFiltradaDTO(int id, String titulo, String imagen, String instrucciones,
			LocalDateTime fechaCreacion, int tiempo, int comensales, Dificultad dificultad, int likes,
			UsuarioRecetaDTO usuario, TipoRecetaDTO tipoReceta, boolean publicada) {
		this.id = id;
		this.titulo = titulo;
		this.imagen = imagen;
