...
-- TABLA USUARIO RECETA CONSUMIDA
CREATE TABLE usuario_receta_consumida (
	USUARIO varchar(100) NOT NULL,
	RECETA INT NOT NULL,
	FECHA TIMESTAMP NOT NULL,
	CONSTRAINT usuario_receta_consumida_un UNIQUE KEY (USUARIO,RECETA,FECHA),
	CONSTRAINT usuario_receta_consumida_FK FOREIGN KEY (USUARIO) REFERENCES usuarios(ID),
	CONSTRAINT usuario_receta_consumida_FK_1 FOREIGN KEY (RECETA) REFERENCES recetas(ID)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci;